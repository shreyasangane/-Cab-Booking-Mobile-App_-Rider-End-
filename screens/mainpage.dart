...
import 'package:cabrider/riderVariables.dart';
import 'package:cabrider/screens/searchpage.dart';
import 'package:cabrider/styles/style.dart';
      ...
      body: Stack(children: <Widget>[
        GoogleMap(
          ...
          onMapCreated: (GoogleMapController controller) {
            ...
            //mapcontroller works as object for maps
...
//                            await getDirection();
  ...
  Future<void> getDirection() async {
    ...
    var thisDetails =
        await HelperMethods.getDiretionDetails(pickLatLng, destinationLatLng);
    ...
    //code to fit polyline on map with pick and destination
  ...
  void updateToPickup(LatLng driverLocation) async {
    if (!isRequestingLocationDetails) {
      ...
      var thisDetails = await HelperMethods.getDiretionDetails(
